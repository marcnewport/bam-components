 ...
 * ```
 */
type RequestOptions = Partial<google.maps.places.AutocompleteRequest> & {
  shouldFetch?: boolean
}
...
export function useAutocompleteSuggestions(
  ...
  useEffect(() => {
    if (!placesLib || !shouldFetch) return
    ...
    // TODO : handle errors / rate-limiting?
  ...
  }, [placesLib, inputString, requestOptions.shouldFetch])
